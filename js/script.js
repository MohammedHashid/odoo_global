...
const imagineSwitch = document.getElementById('imagineSwitch');
    if (imagineSwitch) {
        imagineSwitch.addEventListener('change', function() {
            const section = document.querySelector('.apps-showcase-section');
            if(this.checked) {
